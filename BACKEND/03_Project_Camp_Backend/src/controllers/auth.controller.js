...
const registerUser = asyncHandler(async (req, res) => {
  ...
  if (existedUser) {
    throw new ApiError(
      409,
      "User with this username and email already exist",
      [],
    );
  }
  ...
  res
    ...
    .json(
      new ApiResponse(
        200,
        { user: createdUser },
        "User registred successfully and verification email sent to your email",
      ),
    );
});
...
const resendEmailVerification = asyncHandler(async (req, res) => {
  ...
  if (user.isEmailVerified) {
    throw new ApiError(404, "Email is already exist");
  }
...
const forgotPasswordRequest = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(
      new ApiResponse(200, "Password reset main has been send to your Email"),
    );
});
...
const changedPassword = asyncHandler(async (req, res) => {
  ...
  if (!isPasswordValid) {
    new ApiError(404, "Invalid Old passwor");
  }
